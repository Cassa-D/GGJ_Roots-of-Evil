...
namespace TarodevController {
    ...
    public class PlayerAnimator : MonoBehaviour {
        ...
        private void Awake() {
            ...
            _healthHandler = GetComponentInParent<PlayerHealthHandler>();
        }
        ...
        private void Start() {
            ...
            _healthHandler.DamageTaken += OnDamageTaken;
        }
        ...
        private void OnLedgeClimbChanged() {
        ...
        private void HandleAnimations() {
            ...
            int GetState() {
                ...
                if (_takenDamage) return LockState(TakeDamage, 0.25f);
        ...
        private static readonly int TakeDamage = Animator.StringToHash("Damage");
        #endregion
        ...
        private void OnDamageTaken() => _takenDamage = true;
    }
}